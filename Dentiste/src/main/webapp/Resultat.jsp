<%@ page import="com.example.dentiste1.model.Consultation" %>
<%@ page import="com.example.dentiste1.model.EtatDuDent" %>
...
<%
  ...
  EtatDuDent[] allD = (EtatDuDent[]) request.getAttribute("dent");
...
<body>
  <table class="table table-bordered" style="width: 1000px; margin: auto">
    ...
    <% for (int i = 0; i < allC.length; i++) { %>
        <tr>
            <td ><% out.print(allC[i].getEtatDuDent().getDent().getLibelle()); %></td>
  ...
  <center style="width: 300px; height: 200px; margin: auto; border: 1px black dashed; border-radius: 5px;padding-top: 20px; margin-top: 10px; margin-bottom: 10px">
  ...
  <table class="table table-bordered" style="width: 1000px; margin: auto">
      ...
      <tr>
          <td ><% out.print(allD[i].getDent().getNumero());%></td>
          <td ><% out.print(allD[i].getDent().getLibelle());%></td>

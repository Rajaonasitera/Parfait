...
<head>
    ...
    <!-- Title Page-->
    <title>Route</title>
    <link href="./styles/images/icon/Route.png" rel="icon">
    ...
    <link href="./styles/vendor/quill/quill.snow.css" rel="stylesheet">
    <link href="./styles/vendor/quill/quill.bubble.css" rel="stylesheet">
    <link href="./styles/vendor/remixicon/remixicon.css" rel="stylesheet">
    <link href="./styles/vendor/simple-datatables/style.css" rel="stylesheet">
        ...
        <div class="menu-sidebar__content js-scrollbar1">
            <nav class="navbar-sidebar">
                <ul class="list-unstyled navbar__list">
                    <li>
                        <a href="PageListRouteServlet">
                            <i class="fas fa-chart-bar"></i>Consultation route</a>
                    </li>
